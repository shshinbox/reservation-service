...
import me.songha.concert.reservation.controller.dto.payment.PaymentWebhookRequest;
import me.songha.concert.reservation.controller.dto.payment.PaymentWebhookResponse;
...
public class PaymentWebhookController {
    ...
    public ResponseEntity<PaymentWebhookResponse> receive(
        ...
        ReservationOperationResult result = reservationOperationService.confirmPaid(request.reservationId());
        if (!result.completed()) {
