...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, SeatHoldEvent> seatHoldConsumerFactory(
        ...
        props.put(JacksonJsonDeserializer.VALUE_DEFAULT_TYPE, SeatHoldEvent.class.getName());
        props.put(JacksonJsonDeserializer.TRUSTED_PACKAGES, "me.songha.concert.reservation.kafka");
